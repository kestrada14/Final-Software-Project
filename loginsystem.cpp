...
void LoginSystem::on_completeRegButton_2_clicked(){
    ui->winStack->setCurrentIndex(4);
}

void LoginSystem::on_completeRegButton_3_clicked(){
    // logged in page ui->winStack->setCurrentIndex(4);
}
...
void LoginSystem::on_completeRegButton_clicked()
{
    ...
    if(ui->fBox->text() == "")
    {
        ...
        datalibDb.createuser(ui->fBox->text());
...
//    dataDb.createuser(ui->uBox->text());
...
void LoginSystem::on_backButton_3_clicked()
{
    ui->winStack->setCurrentIndex(1);
}

void LoginSystem::on_backButton_4_clicked()
{
    ui->winStack->setCurrentIndex(2);
}
void LoginSystem::on_backButton_8_clicked()
{
    ui->winStack->setCurrentIndex(2);
}
void LoginSystem::on_backButton_7_clicked()
{
    ui->winStack->setCurrentIndex(2);
}
